...
init()
{
  ...
  VelDispRz_gashalo=matrix(0,RSIZE,0,ZSIZE);
  VelDispRz_dR_gashalo=matrix(0,RSIZE,0,ZSIZE);
  VelDispPhi_gashalo=matrix(0,RSIZE,0,ZSIZE);
  VelVc2_gashalo=matrix(0,RSIZE,0,ZSIZE);
  VelStreamPhi_gashalo=matrix(0,RSIZE,0,ZSIZE);
